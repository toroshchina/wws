...
export function Lines(props) {
  ...
  useEffect(() => {
    ...
    function getLines(pathname) {
      if (
        props.location.pathname === '/dashboard/lines' ||
  ...
  return (
    <div className={styles.userBlock}>
      <Route exact path={path}>
        <Grid container className={styles.headerBlock}>
          ...
          <Grid item className={styles.titleBlock}>
            <Typography variant="h4">Линейки</Typography>
          </Grid>
      ...
      <Route path={`${path}/detail/:lineId`} component={Detail} />
    </div>
  );
}
